...
public class PearceContainer implements IRobotContainer {
  ...
  public static IRobotContainer createContainer(){
    ...
    SECTOR_EVALUATOR.createSector(RobotSector.baseSector.BLUE, RobotSector.sectorType.NONE,new Pose2d(3.,1.,new Rotation2d()),1,1);
    SECTOR_EVALUATOR.createSector(RobotSector.baseSector.BLUE, RobotSector.sectorType.NONE,new Pose2d(1.,3.,new Rotation2d()),1,1);
    SECTOR_EVALUATOR.createSector(RobotSector.baseSector.BLUE, RobotSector.sectorType.NONE,new Pose2d(3.,3.,new Rotation2d()),1,1);
